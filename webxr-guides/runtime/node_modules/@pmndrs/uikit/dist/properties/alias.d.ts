...
declare const flexAliases: {
    ...
    readonly paddingInline: readonly ["paddingLeft", "paddingRight"];
    readonly paddingInlineStart: readonly ["paddingLeft"];
    readonly paddingInlineEnd: readonly ["paddingRight"];
    readonly paddingY: readonly ["paddingTop", "paddingBottom"];
    readonly paddingBlock: readonly ["paddingTop", "paddingBottom"];
    readonly paddingBlockStart: readonly ["paddingTop"];
    readonly paddingBlockEnd: readonly ["paddingBottom"];
    readonly margin: readonly ["marginBottom", "marginTop", "marginLeft", "marginRight"];
    readonly marginX: readonly ["marginLeft", "marginRight"];
    readonly marginInline: readonly ["marginLeft", "marginRight"];
    readonly marginInlineStart: readonly ["marginLeft"];
    readonly marginInlineEnd: readonly ["marginRight"];
    readonly marginY: readonly ["marginTop", "marginBottom"];
    readonly marginBlock: readonly ["marginTop", "marginBottom"];
    readonly marginBlockStart: readonly ["marginTop"];
    readonly marginBlockEnd: readonly ["marginBottom"];
